...
sortable_post_table.sortable({
	...
	update: function(e, ui) {
		...
		jQuery.post( ajaxurl, { action: 'reveal_slide_ordering', id: postid, previd: prevpostid, nextid: nextpostid }, update_simple_ordering_callback );
